...
def invoke(data1, data2, data3,id_list) -> pd.DataFrame():
    ...
    fa_index = [
        'reads_pos_regi_sum', 'user_avg_bar_age_pos', 'reads_all_regi_sum',
        'posts_all_regi_sum', 'uids_all', 'user_avg_bar_age_all',
        'reads_neg_unregi_sum', 'replies_neg_unregi_sum',
        'posts_neg_unregi_sum', 'reads_neu_unregi_sum',
        'replies_neu_unregi_sum', 'posts_neu_unregi_sum',
        'reads_pos_unregi_sum', 'replies_pos_unregi_sum',
        'posts_pos_unregi_sum', 'reads_all_unregi_sum',
        'replies_all_unregi_sum', 'posts_all_unregi_sum',
        'reads_pos_alluser_sum', 'reads_all_alluser_sum',
        'posts_all_alluser_sum', 'unregi_senti_score_div',
        'unregi_senti_score_log', 'unregi_senti_conform',
        'regi_senti_score_div', 'regi_senti_score_log', 'regi_senti_conform',
        'senti_score_div', 'senti_score_log', 'senti_conform',
        'reads_neg_regi_sum_rolling5', 'user_avg_bar_age_neg_rolling5',
        'reads_pos_regi_sum_rolling5', 'user_avg_bar_age_pos_rolling5',
        'reads_all_regi_sum_rolling5', 'posts_all_regi_sum_rolling5',
        'uids_all_rolling5', 'user_avg_bar_age_all_rolling5',
        'reads_neg_unregi_sum_rolling5', 'replies_neg_unregi_sum_rolling5',
        'posts_neg_unregi_sum_rolling5', 'reads_neu_unregi_sum_rolling5',
        'replies_neu_unregi_sum_rolling5', 'posts_neu_unregi_sum_rolling5',
        'reads_pos_unregi_sum_rolling5', 'replies_pos_unregi_sum_rolling5',
        'posts_pos_unregi_sum_rolling5', 'reads_all_unregi_sum_rolling5',
        'replies_all_unregi_sum_rolling5', 'posts_all_unregi_sum_rolling5',
        'reads_neg_alluser_sum_rolling5', 'reads_pos_alluser_sum_rolling5',
        'reads_all_alluser_sum_rolling5', 'posts_all_alluser_sum_rolling5',
        'unregi_senti_score_div_rolling5', 'unregi_senti_score_log_rolling5',
        'unregi_senti_conform_rolling5', 'regi_senti_score_div_rolling5',
        'regi_senti_score_log_rolling5', 'regi_senti_conform_rolling5',
        'senti_score_div_rolling5', 'senti_score_log_rolling5',
        'senti_conform_rolling5'
    ]
    fb_index = [
        'fav_neg_sum', 'retweet_neg_sum', 'like_neu_sum', 'fav_neu_sum',
        'retweet_neu_sum', 'reply_neu_sum', 'post_neu_sum', 'uid_neu',
        'user_avg_barage_neu', 'like_pos_sum', 'fav_pos_sum', 'retweet_pos_sum',
        'reply_pos_sum', 'post_pos_sum', 'uid_pos', 'user_avg_barage_pos',
        'like_all_sum', 'fav_all_sum', 'retweet_all_sum', 'reply_all_sum',
        'post_all_sum', 'uid_all', 'user_avg_barage_all', 'senti_score_div',
        'senti_score_log', 'fav_neg_sum_rolling5', 'retweet_neg_sum_rolling5',
        'like_neu_sum_rolling5', 'fav_neu_sum_rolling5',
        'retweet_neu_sum_rolling5', 'reply_neu_sum_rolling5',
        'fav_pos_sum_rolling5', 'retweet_pos_sum_rolling5',
        'reply_pos_sum_rolling5', 'post_pos_sum_rolling5', 'uid_pos_rolling5',
        'fav_all_sum_rolling5', 'retweet_all_sum_rolling5',
        'post_all_sum_rolling5', 'uid_all_rolling5',
        'user_avg_barage_all_rolling5'
    ]
